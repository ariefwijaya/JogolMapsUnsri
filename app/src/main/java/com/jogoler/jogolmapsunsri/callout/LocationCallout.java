package com.jogoler.jogolmapsunsri.callout;
...
public class LocationCallout extends RelativeLayout{
    ...
    public LocationCallout(Context context ) {
        ...
        icon.setId( 2 );
        icon.setImageResource( R.drawable.marker_navigation );
